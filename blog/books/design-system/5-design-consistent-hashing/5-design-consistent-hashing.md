...
![Figure 5-1](images/System-Design-Interview-page72-image1.jpg)
...
![Figure 5-2](images/System-Design-Interview-page73-image1.jpg)
...
![Figure 5-3](images/System-Design-Interview-page73-image2.jpg)
...
![Figure 5-4](images/System-Design-Interview-page75-image1.jpg)
...
![Figure 5-5](images/System-Design-Interview-page75-image2.jpg)
...
![Figure 5-6](images/System-Design-Interview-page76-image1.jpg)

![Figure 5-7](images/System-Design-Interview-page76-image2.jpg)
...
![Figure 5-8](images/System-Design-Interview-page77-image1.jpg)
...
![Figure 5-9](images/System-Design-Interview-page78-image1.jpg)
...
![Figure 5-10](images/System-Design-Interview-page79-image1.jpg)
...
![Figure 5-11](images/System-Design-Interview-page80-image1.jpg)

![Figure 5-12](images/System-Design-Interview-page80-image2.jpg)
...
![Figure 5-13](images/System-Design-Interview-page81-image1.jpg)
...
![Figure 5-14](images/System-Design-Interview-page82-image1.jpg)
...
> ***یادداشت شخصی***
> 🔗 [ترجمه کامل مقاله Tom White](post.html?cat=books&slug=consistent-hashing-tom-white) - بهترین توضیح ساده و عملی از هشینگ سازگار با پیاده‌سازی Java

[۳] Dynamo: Amazon's Highly Available Key-value Store: https://www.allthingsdistributed.com/files/amazon-dynamo-sosp2007.pdf
> ***یادداشت شخصی***
> 🔗 [ترجمه کامل مقاله Dynamo](post.html?cat=books&slug=dynamo-paper) - مقاله اصلی آمازون که هشینگ سازگار را برای پارتیشن‌بندی داده معرفی کرد
...
> ***یادداشت شخصی***
> 🔗 [ترجمه کامل مقاله Cassandra](post.html?cat=books&slug=cassandra-paper) - سیستم NoSQL فیسبوک که از هشینگ سازگار برای پارتیشن‌بندی استفاده می‌کند

[۵] How Discord Scaled Elixir to 5,000,000 Concurrent Users: https://blog.discord.com/scaling-elixir-f9b8e1e7c29b
> ***یادداشت شخصی***
> 🔗 [ترجمه کامل مقاله Discord](post.html?cat=books&slug=discord-scaling) - چگونه Discord تریلیون‌ها پیام را با هشینگ سازگار ایندکس می‌کند
...
> ***یادداشت شخصی***
> 🔗 [یادداشت‌های CS168 Stanford](post.html?cat=article&slug=cs168-consistent-hashing) - پایه‌های الگوریتمی هشینگ سازگار از دوره استنفورد
...
> ***یادداشت شخصی***
> 🔗 [ترجمه کامل مقاله Maglev](post.html?cat=books&slug=maglev-paper) - متعادل‌کننده بار شبکه گوگل که از هشینگ سازگار استفاده می‌کند
